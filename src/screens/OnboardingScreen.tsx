...
const OnboardingScreen: React.FC<OnboardingScreenProps> = ({ onComplete }) => {
  ...
  const exercises = [
    {
      ...
      instruction:
        "How many push-ups can you do comfortably? (Type any number!)",
      unit: "reps",
      min: 1,
      defaultValue: 10,
    },
    ...
    },
    {
      ...
      instruction:
        "How many sit-ups can you do comfortably? (Type any number!)",
      unit: "reps",
      min: 1,
      defaultValue: 10,
    },
    {
      ...
      instruction:
        "How long can you hold a plank comfortably? (Type any number!)",
      unit: "seconds",
      min: 10,
      defaultValue: 30,
    },
  ...
  const handleFinish = () => {
    ...
    if (!isValid) {
      Alert.alert(
        "Invalid Input",
        "Please ensure all exercise values are greater than 0."
      );
      return;
    }
      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.exerciseCard}>
                  ...
                  {[
                    ...
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        baselines[currentExercise.key] === value &&
                          styles.quickSelectButtonActive,
                      ]}
                      onPress={() =>
                        setBaselines((prev) => ({
                          ...prev,
                          [currentExercise.key]: value,
                        }))
                      }
                    >
                      <Text
            ...
            <View style={styles.tipsContainer}>
              ...
              <Text style={styles.tipsText}>
                You can type any number! Whether you're starting at 5 or 100,
                choose what feels right for your current fitness level. You'll
                add +1 every day!
              </Text>
            </View>
          </View>
          ...
          <View style={styles.previewContainer}>
            <Text style={styles.previewTitle}>Your Day 100 Target:</Text>
            <Text style={styles.previewText}>
              {currentExercise.key === "planks"
                ? `${baselines[currentExercise.key] + 74 * 5} seconds`
                : `${baselines[currentExercise.key] + 74} ${
